...
export default class CameraScreen extends React.Component {
  ...
  renderGallery() {
    return <GalleryView onPress={this.toggleView.bind(this)} />;
  }
  ...
  renderBottomBar = () =>
    <View
      ...
      >
        <Ionicons name={this.state.recordingIcon} size={30} color={this.state.bcolor} />
      </TouchableOpacity>
      <TouchableOpacity
        style={styles.bottomButton}
        onPress={this.takePicture}
      >
        <Ionicons name='ios-radio-button-off' size={30} color="white" />
      </TouchableOpacity>
